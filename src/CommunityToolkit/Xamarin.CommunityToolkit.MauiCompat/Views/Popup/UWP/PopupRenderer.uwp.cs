	...
	public class PopupRenderer : Flyout, IVisualElementRenderer
	{
		...
		void Show()
		{
			if (Element?.Anchor != null)
			{
				...
				Microsoft.UI.Xaml.Controls.Primitives.FlyoutBase.SetAttachedFlyout(anchor, this);
				Microsoft.UI.Xaml.Controls.Primitives.FlyoutBase.ShowAttachedFlyout(anchor);
			}
			else
			{
				var frameworkElement = Platform.GetRenderer(Element?.Parent as VisualElement)?.ContainerElement;
				Microsoft.UI.Xaml.Controls.Primitives.FlyoutBase.SetAttachedFlyout(frameworkElement, this);
				Microsoft.UI.Xaml.Controls.Primitives.FlyoutBase.ShowAttachedFlyout(frameworkElement);
			}
